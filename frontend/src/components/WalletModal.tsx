...
function WalletDropdown({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="absolute top-full right-0 mt-2 w-[calc(100vw-2rem)] sm:w-80 rounded-2xl border border-zinc-800/60 bg-[#18181b] shadow-[0_16px_48px_-12px_rgba(0,0,0,0.6)] overflow-hidden z-50"
    >
      {/* Header */}
